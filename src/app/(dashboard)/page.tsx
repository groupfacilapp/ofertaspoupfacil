  ...
  return (
    <div className="space-y-6 max-w-5xl md:px-2 md:py-2">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        {/* Total Produtos */}
        <div
          className="rounded-2xl border border-blue-500/80 bg-zinc-900/40 backdrop-blur-md p-4 shadow-[0_0_15px_-2px_rgba(59,130,246,0.3)] relative overflow-hidden group hover:shadow-[0_0_20px_1px_rgba(59,130,246,0.4)] transition-shadow"
          title="Total de ofertas coletadas na sua fila."
        >
          <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
            <Package className="h-20 w-20 transform translate-x-4 -translate-y-4" />
          </div>
          <div className="flex items-center gap-2 mb-3 relative z-10">
            <div className="rounded-full p-1.5 bg-blue-500/10 ring-1 ring-blue-500/30 text-blue-400">
          ...
          <p className="text-3xl font-bold text-white relative z-10">{totalOffers}</p>
        </div>

        {/* Enviados hoje */}
        <div
          className="rounded-2xl border border-emerald-500/80 bg-zinc-900/40 backdrop-blur-md p-4 shadow-[0_0_15px_-2px_rgba(16,185,129,0.3)] relative overflow-hidden group hover:shadow-[0_0_20px_1px_rgba(16,185,129,0.4)] transition-shadow"
        >
          <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
            <Send className="h-20 w-20 transform translate-x-4 -translate-y-4" />
          </div>
          <div className="flex items-center gap-2 mb-3 relative z-10">
            <div className="rounded-full p-1.5 bg-emerald-500/10 ring-1 ring-emerald-500/30 text-emerald-400">
          ...
          <p className="text-3xl font-bold text-white relative z-10">{todayMessages}</p>
        </div>

        {/* Pendentes */}
        <div
          className="rounded-2xl border border-amber-500/80 bg-zinc-900/40 backdrop-blur-md p-4 shadow-[0_0_15px_-2px_rgba(245,158,11,0.3)] relative overflow-hidden group hover:shadow-[0_0_20px_1px_rgba(245,158,11,0.4)] transition-shadow"
        >
          <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
            <Clock className="h-20 w-20 transform translate-x-4 -translate-y-4" />
          </div>
          <div className="flex items-center gap-2 mb-3 relative z-10">
            <div className="rounded-full p-1.5 bg-amber-500/10 ring-1 ring-amber-500/30 text-amber-400">
        ...
        {/* Esta semana */}
        <div
          className="rounded-2xl border border-purple-500/80 bg-zinc-900/40 backdrop-blur-md p-4 shadow-[0_0_15px_-2px_rgba(168,85,247,0.3)] relative overflow-hidden group hover:shadow-[0_0_20px_1px_rgba(168,85,247,0.4)] transition-shadow"
        >
          <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
            <BarChart3 className="h-20 w-20 transform translate-x-4 -translate-y-4" />
          </div>
          <div className="flex items-center gap-2 mb-3 relative z-10">
            <div className="rounded-full p-1.5 bg-purple-500/10 ring-1 ring-purple-500/30 text-purple-400">
          ...
          <p className="text-3xl font-bold text-white relative z-10">{totalWeekDispatches}</p>
        </div>

        {/* Falhas */ }
        <div
          className="rounded-2xl border border-rose-500/50 bg-zinc-900/40 backdrop-blur-md p-4 shadow-[0_0_15px_-2px_rgba(244,63,94,0.1)] relative overflow-hidden group hover:shadow-[0_0_20px_1px_rgba(244,63,94,0.2)] transition-shadow"
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-3 relative z-10">
            <div className="rounded-full p-1.5 bg-rose-500/10 ring-1 ring-rose-500/30 text-rose-400">
          ...
          <p className="text-3xl font-bold text-white relative z-10">{todayFailed}</p>
        </div>
      </div>

      {/* Section 3: 7-day bar chart visually upgraded */}
      <div className="rounded-2xl border border-zinc-800/60 bg-zinc-900/50 backdrop-blur-xl overflow-hidden shadow-xl ring-1 ring-white/5">
        <div className="px-6 py-5 border-b border-white/5 flex items-center justify-between bg-zinc-900/40">
          ...
          <span className="text-xs font-medium text-zinc-400 bg-zinc-800/50 px-3 py-1.5 rounded-full border border-zinc-700/50">
              ...
              {chartDays.map((day) => {
                ...
                return (
                  <div key={day.date} className="flex-1 flex flex-col items-center gap-3 relative group">
                    ...
                    <span className={`text-[11px] font-medium ${isToday ? 'text-white' : 'text-zinc-500'}`}>
                      {day.label}
                    </span>
                  </div>
                );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="rounded-2xl border border-zinc-800/60 bg-zinc-900/50 backdrop-blur-xl overflow-hidden shadow-xl ring-1 ring-white/5">
          <div className="px-6 py-5 border-b border-white/5 bg-zinc-900/40">
            <h2 className="text-sm font-semibold text-white tracking-wide">Produtos por Marketplace</h2>
            <p className="text-xs text-zinc-500 mt-1">Distribuição do catálogo</p>
          </div>
          <div className="p-6">
            {totalOffers === 0 ? (
              ...
              <div className="space-y-5">
                {(Object.keys(marketplaceCounts) as string[]).map((mp) => {
                  ...
                  const barGradientClass = 
                    ...
                    mp === 'mercadolivre' ? 'bg-gradient-to-r from-yellow-300 to-amber-400 shadow-[0_0_10px_rgba(253,224,71,0.3)] text-zinc-900' :
                  ...
                  return (
                    <div key={mp} className="space-y-2 group">
                      <div className="flex items-center justify-between">
                        <span className="text-[11px] font-semibold text-zinc-300 tracking-wider uppercase">{MARKETPLACE_LABELS[mp]}</span>
                        <span className="text-[11px] font-bold text-white bg-zinc-800/80 px-2 py-0.5 rounded">{count}</span>
                      </div>
        ...
        <div className="rounded-2xl border border-zinc-800/60 bg-zinc-900/50 backdrop-blur-xl overflow-hidden shadow-xl ring-1 ring-white/5">
          <div className="px-6 py-5 border-b border-white/5 bg-zinc-900/40">
            <h2 className="text-sm font-semibold text-white tracking-wide">Instância WhatsApp</h2>
            <p className="text-xs text-zinc-500 mt-1">Status da conexão</p>
          </div>
          <div className="p-6">
            {waConnected ? (
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-sm font-bold text-emerald-400 tracking-wide uppercase">Conectado</p>
                  </div>
              ...
              <div className="flex items-start gap-4">
                <div className="rounded-xl bg-rose-500/10 p-4 ring-1 ring-rose-500/30">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-sm font-bold text-rose-400 tracking-wide uppercase">Desconectado</p>
                  </div>
                  <p className="text-xs text-zinc-400 mt-0.5 leading-relaxed">
                    Configure sua instância acessando a aba{' '}
                    <Link href="/canais" className="text-indigo-400 hover:text-indigo-300 font-medium underline underline-offset-4">
                      Canais
                    </Link>
                  </p>
                </div>
            ...
            <div className="mt-6 pt-5 border-t border-white/5 grid grid-cols-2 gap-4">
              <div className="rounded-xl bg-zinc-800/30 border border-zinc-800/50 p-4 hover:bg-zinc-800/50 transition-colors">
                <p className="text-[10px] text-zinc-500 font-semibold uppercase tracking-wider mb-1.5">Grupos Ativos</p>
                <p className="text-2xl font-bold text-white">{activeGroups ?? 0}</p>
              </div>
              <div className="rounded-xl bg-zinc-800/30 border border-zinc-800/50 p-4 hover:bg-zinc-800/50 transition-colors">
                <p className="text-[10px] text-zinc-500 font-semibold uppercase tracking-wider mb-1.5">Marketplaces Config</p>
                <p className="text-2xl font-bold text-white">{connectedMarketplaces ?? 0}<span className="text-sm text-zinc-600 font-medium">/5</span></p>
              </div>
            </div>
          </div>
        </div>
      ...
      {allDone ? (
        <div className="flex items-center gap-4 rounded-2xl border border-emerald-500/30 bg-emerald-500/5 backdrop-blur-md px-6 py-5 shadow-[0_0_20px_-5px_rgba(16,185,129,0.15)]">
          <div className="rounded-full bg-emerald-500/20 p-2">
            <CheckCircle2 className="h-6 w-6 text-emerald-400 shrink-0" />
          </div>
          <div>
            <p className="text-sm font-bold text-emerald-400">Tudo configurado com sucesso!</p>
            <p className="text-xs text-zinc-400 mt-1">
              Seus disparos estão prontos. Acompanhe a performance pelo{' '}
              <Link href="/historico" className="text-white hover:text-indigo-300 font-medium underline underline-offset-4 transition-colors">
                histórico
              </Link>.
            </p>
          </div>
            ...
            {pendingSteps.map((action) => {
              ...
              return (
                <Link
                  key={action.href}
                  href={action.href}
                  className="flex flex-col gap-3 rounded-2xl border border-zinc-800/60 bg-zinc-900/40 backdrop-blur-md px-5 py-5 hover:bg-zinc-800/60 hover:border-indigo-500/50 hover:shadow-[0_0_20px_-5px_rgba(99,102,241,0.2)] transition-all group relative overflow-hidden"
                >
                  ...
                  <div className="flex items-center gap-3 relative z-10 mb-1">
                    <div className="rounded-lg bg-zinc-800/80 p-2 group-hover:bg-indigo-500/20 group-hover:text-indigo-400 transition-colors">
                      <Icon className="h-4 w-4 text-zinc-400 group-hover:text-indigo-400 transition-colors" />
                    </div>
                    <ArrowRight className="h-4 w-4 text-zinc-600 group-hover:text-indigo-400 group-hover:translate-x-1 transition-all ml-auto" />
                  </div>
                  <div className="relative z-10">
                    <p className="text-sm font-bold text-zinc-200 group-hover:text-white transition-colors">{action.title}</p>
                    <p className="text-xs text-zinc-500 mt-1 group-hover:text-zinc-400 transition-colors">{action.desc}</p>
                  </div>
                </Link>
              );
            })}
